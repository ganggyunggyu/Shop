...
import { countPlus, countMinus, agePlus } from "../store.js";
...
export default function Cart() {
  const cartList = useSelector((cartList) => {return cartList['cartList']})
  const userInfo = useSelector((user)=>{return user['user']})
